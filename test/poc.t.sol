...
contract SenecaPoC is Test {
    IERC20 constant resETH = IERC20(0xB05cABCd99cf9a73b19805edefC5f67CA5d1895E);
    IChamber constant CHAMBER = IChamber(0xBC83F2711D0749D7454e4A9D53d8594DF0377c05);

    function setUp() public {
        vm.createSelectFork("eth", 19325937);
    ...
    function testPoc() public {
        ...
        address callee = 0xB05cABCd99cf9a73b19805edefC5f67CA5d1895E;
